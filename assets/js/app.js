...
const volumeTracks = $$('.progress__track.volume--track .progress__track-update');
...
const app = {
    ...
    handleEvents: function() {
        ...
        nextBtn.onclick = function() {
            ...
            tempIndex = _this.currentIndex !== 0 ? _this.currentIndex - 1 : _this.songs.length - 1
    ...
    scrollToActiveSong: function(currentIndex, oldIndex) {
        ...
        setTimeout(function() {
            if ((currentIndex === 0 && oldIndex === songArrayLength - 1) || (currentIndex === songArrayLength - 1 && oldIndex === 0)) {
    ...
    playRandomSong: function() {
        ...
        let avoidRepeatSongsLength = this.avoidRepeatSongs.length > 0 ? this.avoidRepeatSongs.length : 0
        do {
